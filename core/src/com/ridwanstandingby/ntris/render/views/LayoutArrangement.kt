...
enum class LayoutArrangement(val viewRules: List<ViewRule>) {
    ...
    RIGHT_HANDED(listOf(
            ...
            ViewRule(Vector2(10.5f, 09.0f), Vector2(04.0f, 04.0f), ButtonView::RotateLeftButtonView),
            ViewRule(Vector2(14.5f, 09.0f), Vector2(04.0f, 04.0f), ButtonView::RotateRightButtonView),
